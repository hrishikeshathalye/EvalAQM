...
app.controller('DashController', ['$scope', '$window', 'sources', 'contributors', 'dashifTestVectors', function ($scope, $window, sources, contributors, dashifTestVectors) {
    $scope.selectedItem = {
        url: 'http://10.0.0.6:3000/assets/bbb/BigBuckBunny_2s_simple_2014_05_09.mpd'
    };
    ...
    function updateMetrics(type) {
        ...
        if (dashMetrics && $scope.currentStreamInfo) {
            ...
            console.log("Bitrate : " + $scope.videoBitrate)
            console.log("Index Downloading : " + $scope.videoPendingIndex)
            console.log("Index Playing : " + $scope.videoIndex)
            console.log("Dropped Frames : " + $scope.videoDroppedFrames)
